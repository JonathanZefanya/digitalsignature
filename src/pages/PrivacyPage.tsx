    ...
    <div className="flex-1 flex flex-col animate-in fade-in zoom-in-95 duration-500 overflow-auto">
      <div className="flex-1 max-w-2xl mx-auto px-6 py-20 pt-24">
        ...
        <div className="space-y-8 text-zinc-600 dark:text-zinc-400">
          <p className="text-lg">
            DigitalSignature berkomitmen untuk melindungi privasi Anda. Kebijakan ini menjelaskan bagaimana
          ...
          <section className="space-y-3">
            ...
            <p>
              DigitalSignature adalah aplikasi yang berjalan sepenuhnya di browser Anda. DigitalSignature{' '}
          ...
          <section className="space-y-3">
            ...
            <p>
              DigitalSignature mendukung PDF yang dilindungi password. Saat Anda membuka file PDF
